...
export class PerfectScrollbarDirective implements AfterViewInit, OnDestroy {
    ...
    @Input()
    set aurPerfectScrollbarOptions(value) {
        // Merge the options
        this._options = _.merge({}, this._options, value);
    }

    get aurPerfectScrollbarOptions(): any {
        // Return the options
        return this._options;
    }

    @Input('aurPerfectScrollbar')
    ...
    ngAfterViewInit(): void {
        ...
        if (this.aurPerfectScrollbarOptions.updateOnRouteChange) {
            this._router.events
                .pipe(
    ...
    _init(): void {
        ...
        this.ps = new PerfectScrollbar(this.elementRef.nativeElement, {
            ...this.aurPerfectScrollbarOptions
        });
    }
